package com.ownourome.musicmp3.ui.main.rank.usuk;
...
public class UsUkFragment extends Fragment{
    ...
    private void initViews(View view) {
        RecyclerView recyclerViewUSUK = view.findViewById(R.id.recyclerViewUSUK);
        ...
        recyclerViewUSUK.setAdapter(mSongAdapter);
    }
